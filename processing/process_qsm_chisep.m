...
if strcmp(RunOptions.R2sfit, 'Use preprocessed R2* or R2'' map')  % If you have R2s or R2p
    r2s_nii = load_untouch_nii(r2s_file);
    Data.R2s = double(r2s_nii.img);
    if RunOptions.HaveR2Prime == 1
        r2p_nii = load_untouch_nii(r2p_file);
        Data.R2p = double(r2p_nii.img);
    end
else  % R2s fitting
...
switch RunOptions.Chisep
    case 'Chi-sepnet'
        ...
        if RunOptions.resgen
            ...
            [Data.x_para, Data.x_dia, Data.x_tot, Data.qsm_map, Data.r2p_map] = chi_sepnet_general_new_wResolGen(...
                home_directory,...
                Data.local_field_hz,...
                Data.map,...
                Data.mask_brain_new,...
                ...
                Data.CF,...
                Data.VoxelSize,...
                RunOptions.HaveR2Prime,...
                Data.B0_strength,...
                RunOptions.is_scaling,...
                RunOptions.scaling_factor,...
                RunOptions.interp_method,...
                RunOptions.sinc_window_size,...
                RunOptions.sinc_window_type...
            );
        else
            % Interpolate the input maps to 1 mm isotropic resolution.
            [Data.x_para, Data.x_dia, Data.x_tot, Data.qsm_map, Data.r2p_map] = chi_sepnet_general_sinc(...
                home_directory,...
                Data.local_field_hz,...
                Data.map,...
                Data.mask_brain_new,...
    ...
    case 'Chi-separation (MEDI)'
        ...
        [Data.x_para, Data.x_dia, Data.x_tot] = chi_sep_MEDI(...
            Data.mag,...
            Data.local_field_hz,...
            Data.r2prime,...
            N_std,...
    ...
    case 'Chi-separation (iLSQR)'
        ...
        option_data.qsm = Data.QSM;
        option_data.N_std = N_std;
        [Data.x_para, Data.x_dia, Data.x_tot] = chi_sep_iLSQR(...
            Data.mag,...
            Data.local_field_hz,...
            Data.r2prime,...
            Data.mask_brain_new,...
...
switch RunOptions.VesselSeg
    case 'Deep-learning'
        [Data.vesselMask_para, Data.vesselMask_dia] = vesselSegmentation_Chiseparation_DL(...
            home_directory,...
            Data.x_para,...
            Data.x_dia,...
            Data.mask_brain_new,...
    ...
    case 'Region-growing'
        ...
        [paraMask_init, diaMask_init, homogeneityMeasure_p, homogeneityMeasure_d] = vesselSegmentation_Chiseparation(...
            seedInput,...
            baseInput,...
            Data.mask_brain_new,...
            min(Data.mask_brain_new, 1 - Data.mask_CSF),...
            params...
        );
