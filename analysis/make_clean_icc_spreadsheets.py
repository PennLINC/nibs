...
def _retain_common_metrics(
    ...
    common_metrics = SELECTED_METRICS.intersection(gm_df['metric']).intersection(wm_df['metric'])
...
def main() -> None:
    ...
    gm_median_clean, wm_median_clean = _retain_common_metrics(gm_median_clean, wm_median_clean)
